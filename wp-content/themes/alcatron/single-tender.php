        ...
        <div class="row">
            ...
            <div class="large-6 columns">
                <?php //$title_ws_1 = get_field ( 'workshop-1', 'option' );?>
                    ...
                    $achiveurl= get_post_type_archive_link( 'tender' );                   
                                        
                    echo '<ul class="breadcrumbs right"><li class="home"><a href="'.home_url().'">'.__('Home', 'Alcatron').'</a></li><li><a href="'.$achiveurl.'">Tender</a></li><li>&nbsp&nbsp'.get_the_title().'</li></ul>';
					} ?>
