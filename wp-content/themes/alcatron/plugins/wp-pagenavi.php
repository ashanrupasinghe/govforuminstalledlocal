...
function wp_pagenavi($before = '', $after = '') {
	...
	$pagenavi_options = array(
		...
		'next_text' => __('<span class="icon-chevron-right"></span>','Alcatron'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','Alcatron'),
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('','Alcatron'),
		'last_text' => __('','Alcatron'),
		'next_text' => __('<span class="icon-chevron-right"></span>','Alcatron'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','Alcatron'),
		'dotright_text' => __('...','Alcatron'),
		'dotleft_text' => __('...','Alcatron'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
