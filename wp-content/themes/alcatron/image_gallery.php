	...
	<div class="row">
        <?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
            ...
            <div class="<?php echo $layout == '1' ? 'large-12' : 'large-8'?> columns">
                ...
                <?php while(the_flexible_field("album")): ?>
                <?php if(get_row_layout() == "photo_album"): // layout: Content ?>
                <?php 
                ...
                $row_shortcode.='[one_third][tblock title="'.$title.'" image="'.$icon.'"/]'.$short_code.'<p>'.$description.'</p>[/one_third]';
