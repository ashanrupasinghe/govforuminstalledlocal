    ...
    <div class="large-12 columns main-content-top">
        <div class="row">
            <div class="large-6 columns">
                <h2><?php printf( __( 'Search Results for: %s', 'Alcatron' ), '<mark>' . get_search_query() . '</mark>' ); ?></h2>
            </div>        
            <div class="large-6 columns">
...
<div class="content_wrapper">	
		<div class="row">
			<?php if ($layout == '3'):?>
				<aside class="large-4 columns sidebar-left" id="sidebar"> <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Blog Sidebar") ) : ?> <?php   endif;?></aside>
			<?php endif?>
			...
			<div class="<?php echo $layout == '1' ? 'large-12' : 'large-8'?> columns"> 
				...
				<?php else : ?>
					<div id="post-0" class="post no-results not-found">
						<h4><?php _e( 'Nothing Found', 'Alcatron' ); ?></h4>
						<div class="entry-content">
							<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'Alcatron' ); ?></p>
						 </div><!-- .entry-content -->
					</div><!-- #post-0 -->
				<?php endif; ?>
			</div>
			<?php if ($layout == '2'):?>
				<aside class="large-4 columns sidebar-right" id="sidebar"> <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar("Blog Sidebar") ) : ?> <?php   endif;?></aside>
			<?php endif?>
			<div class="clear"></div>
		</div>
</div>
