...
<body>
    <form id="GalleryShortcode">
        ...
        <p>
            ...
            <input type="text" id="fblockContent">
        </p>
        <p>
...
<script type="text/javascript">
    var tooltip={
        ...
        insert: function createGalleryShortcode(e){
            var Align=jQuery('#tooltipAlign').val();
...
<body>
	...
	<p>
		<label for="tooltipAlign">Tooltip Position:</label>
		<select id="tooltipAlign" name="tooltipAlign">
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        jQuery("#add-social").click(function() {
            jQuery('#SocShortcodeContent').append('<p><label for="icon[]">Social Button</label><select id="icon[]" name="icon[]"><option value="icon-facebook">Facebook</option><option value="icon-twitter">Twitter</option><option value="icon-linkedin">LinkedIn</option><option value="icon-google-plus">Google+</option><option value="icon-pinterest">Pinterest</option></select></p><p><label for="link[]">Link to:</label><input type="text" id="link[]" name="link[]"></p><hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />');
    });
    });
</script>
