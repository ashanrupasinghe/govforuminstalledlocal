...
<div id="header">
	<div id="logo-container">
		<h1><img src="<?php echo get_template_directory_uri()?>/library/admin/images/main_logo.png" alt="Alcatron" /></h1>		
	</div>	
    <div id="admin-panel">
...
<div class="wrap alc_wrap">
	<div class="alc_opts">
		<div id="messages">
            ...
            if (isset($_REQUEST['saved'])) echo '<div class="success-message"><p>Settings successfully saved - W P L O C K E R .C OM - </p></div>'; 
            ?>
		</div>
