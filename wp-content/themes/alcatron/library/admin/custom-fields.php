...
function new_meta_boxes( $type ) {
    ...
    echo '<input type="hidden" name="Alcatron_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
...
function create_meta_box() {
	...
	if ( function_exists('add_meta_box') ) {
		add_meta_box( 'new_meta_boxes_page', 'Alcatron'  . ' Page Settings', 'new_meta_boxes_page', 'page', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_post', 'Alcatron'  . ' Post Settings', 'new_meta_boxes_post', 'post', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_portfolio', 'Alcatron'  . ' Portfolio Settings', 'new_meta_boxes_portfolio', 'portfolio', 'normal', 'high' );
	}
}

function save_postdata( $post_id ) {
	
	if ( !wp_verify_nonce(isset($_POST['Alcatron_meta_box_nonce']) ? $_POST['Alcatron_meta_box_nonce'] : '', basename(__FILE__)) ) {
