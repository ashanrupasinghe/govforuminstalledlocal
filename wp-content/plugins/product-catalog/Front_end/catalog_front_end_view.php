 ...
 ob_start();
	...
	$slidechangespeed=$catalog[0]->param;
       ...
       // var_dump($paramssld3);
        ...
        $paramssld["ht_view0_linkbutton_background_hover_color"] = "839CCC";
        $paramssld["ht_view0_linkbutton_background_color"] = "395895";
        ...
        $paramssld["ht_view1_linkbutton_background_hover_color"] = "839CCC";
        $paramssld["ht_view1_linkbutton_background_color"] = "395895";
        ...
        $paramssld["ht_view2_popup_linkbutton_background_hover_color"] = "395895";
        ...
        $paramssld["ht_view3_linkbutton_background_hover_color"] = "395895";
        ...
        $paramssld["ht_view3_title_font_color"] = "395895";
        ...
        $paramssld["ht_view5_linkbutton_background_hover_color"] = "395895";
        ...
        $paramssld["ht_view5_title_font_color"] = "395895";
        ...
        $paramssld["ht_view6_title_font_color"] = "395895";
        ...
        $paramssld["ht_catalog_view0_price_font_color"] = "395895";
        ...
        $paramssld["ht_catalog_view1_price_font_color"] = "395895";
        ...
        $paramssld["ht_catalog_view2_price_font_color"] = "395895";
        ...
        $paramssld["ht_catalog_view3_price_font_color"] = "395895";
        ...
        $paramssld["ht_catalog_view5_price_font_color"] = "395895";
...
<?php
    function html_single_product_page($productArray, $paramssld, $paramssld2, $paramssld3, $paramssld4, $ratingsArray, $reviewsArray, $spamReviewsArray, $captchaFirstNum, $captchaSecondNum, $captcha_val){
        ...
        $paramssld["ht_single_product_title_font_color"] = "395895";
        ...
        $paramssld["ht_single_product_price_font_color"] = "395895";
        $paramssld["ht_single_product_market_price_font_size"] = "14";
        $paramssld["ht_single_product_market_price_font_color"] = "395895";
        ...
        $paramssld["ht_single_product_comments_submit_button_text_background_color"] = "395895";
        $paramssld["ht_single_product_comments_submit_button_text_background_hover_olor"] = "7088B7";
        ...
        $paramssld2["ht_view0_linkbutton_background_hover_color"] = "839CCC";
        $paramssld2["ht_view0_linkbutton_background_color"] = "395895";
        ...
        $paramssld2["ht_view1_linkbutton_background_hover_color"] = "839CCC";
        $paramssld2["ht_view1_linkbutton_background_color"] = "395895";
        ...
        $paramssld2["ht_view2_popup_linkbutton_background_hover_color"] = "395895";
        ...
        $paramssld2["ht_view3_linkbutton_background_hover_color"] = "395895";
        ...
        $paramssld2["ht_view3_title_font_color"] = "395895";
        ...
        $paramssld2["ht_view5_linkbutton_background_hover_color"] = "395895";
        ...
        $paramssld2["ht_view5_title_font_color"] = "395895";
        ...
        $paramssld2["ht_view6_title_font_color"] = "395895";
        ...
        $paramssld2["ht_catalog_view0_price_font_color"] = "395895";
        ...
        $paramssld2["ht_catalog_view1_price_font_color"] = "395895";
        ...
        $paramssld2["ht_catalog_view2_price_font_color"] = "395895";
        ...
        $paramssld2["ht_catalog_view3_price_font_color"] = "395895";
        ...
        $paramssld2["ht_catalog_view5_price_font_color"] = "395895";
        ...
        $paramssld["ht_single_product_asc_seller_button_background_color"] = "395895";
        $paramssld["ht_single_product_asc_seller_button_background_hover_color"] = "395895";
        ...
        $paramssld["ht_single_product_asc_seller_popup_button_background_color"] = "395895";
        $paramssld["ht_single_product_asc_seller_popup_button_background_hover_color"] = "7088B7";
        ...
        $paramssld["ht_single_product_asc_to_seller_text_font_color"]    = "395895";
...
.huge_it_catalog_single_product_page .right-block .share_buttons_block ul {
	display: table;
        /* margin: -2px 0px 0px 40px !important; ashan */
        padding: 0px !important;
...
#catalog-order-popup-1 .empty::-webkit-input-placeholder { color: #395895; }
    ...
    <div class="huge_it_catalog_container">
		...
		<div class="right-block">
			...
			?>
				...
				<span class="label" style="background: #7088B7;"><?php echo $paramssld3["ht_single_product_rating_text"]; ?>:</span>
				<ul class="rating-stars" style="float: right;">
...
//                                        }
				...
				<span class="label" style="background: #7088B7"><?php echo $paramssld3["ht_single_product_share_text"]; ?>:</span>
				<ul>
<!--					<li class="mail">
                            ...
                            <?php
                                 if($paramssld["ht_single_product_show_asc_seller_button"] == 'on'){ ?>
                                     <div class="contact-seller-block">
                                        <div class="order_button" style="cursor:pointer;"><span class="label" style="background-color: #395895;">Order Product<?php // echo $paramssld3['ht_single_product_asc_seller_button_text']; ?></span>
                                        </div>

                                        <div id="catalog-order-popup-1" class="modalDialog">
                                            <div>
                                                    <div title="Close" class="catalog-order-popup-close" style="cursor:pointer">X</div>
                                                    <h2>Order This Product<?php //echo $paramssld3['ht_single_product_asc_to_seller_text']; ?></h2>
...
//                   alert(comments_name + " " + author_comment+ " " + ip + " " + spam + " " + product_id);
    //            return false;
                ...
                jQuery.post("<?php echo admin_url('admin-ajax.php'); ?>", data, function(response) {
                    ...
                    if(response.index == 2){
                        jQuery("#captchaInputValue").parent().find(".invalid").text("<?php echo $paramssld3["ht_single_product_invalid_captcha_text"]; ?>").css({ "color" : "#395895" });
                    }
                });
                return false;
                }
...
//                                jQuery(".modalDialog").css({ opacity: 0 });
    //                            jQuery(".modalDialog ").find("a.catalog-order-popup-close").click();
                            ...
                            if(response.index == 2){
                                jQuery("#catalog-order-popup-1").find(".invalid").text("<?php echo $paramssld3["ht_single_product_invalid_captcha_text"]; ?>").css({ "color" : "#395895" });
                                return false;
                            }
                        });
